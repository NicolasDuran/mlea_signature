...
public class FeatureExtractor {
	...
	public static LocalFeatureVector extractLocalFeature(Signature s)
	{
		...
		if (selector[15]) v.add(features.get(LocalFeature.TIME_INDEX.index));
		...
		if (selector[14]) v.add(features.get(LocalFeature.ABS_POS_DX.index));
		if (selector[13]) v.add(features.get(LocalFeature.ABS_POS_DY.index));
		...
		if (selector[0]) v.add(features.get(LocalFeature.VY.index));
		if (selector[5]) v.add(features.get(LocalFeature.AX.index));
		if (selector[6]) v.add(features.get(LocalFeature.AY.index));
		if (selector[12]) v.add(features.get(LocalFeature.PRESSURE.index));
		if (selector[11]) v.add(features.get(LocalFeature.AZIMUTH.index));
